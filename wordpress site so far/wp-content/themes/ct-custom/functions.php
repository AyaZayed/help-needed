...
if (!function_exists('ct_theme_scripts')) {
	...
	{
		wp_enqueue_media();
		echo get_template_directory_uri() . '/styles/style.css';
		...
		wp_enqueue_script('customizer-js', get_template_directory_uri() . '/js/customizer.js', array(), '1.0.0', true);
		wp_enqueue_script('image-upload', get_template_directory_uri() . '/js/image-upload.js', array(), '1.0.0', true);
		wp_enqueue_script('navigation', get_template_directory_uri() . '/js/navigation.js', array(), '1.0.0', true);
		wp_enqueue_script('skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '1.0.0', true);
	}
